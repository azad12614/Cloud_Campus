                ...
                <div class="row">
                    ...
                    <div class="col-12 col-sm-6 col-lg-3">
                        <div class="single_advisor_profile wow fadeInUp" data-wow-delay="0.2s" style={{ visibility: "visible", animationDelay: "0.2s", animationName: "fadeInUp", }}>
                            ...
                            <div class="single_advisor_details_info">
                                <h6>Prof. Mohammed Shamsul Alam</h6>
                                <p class="designation"> Professor</p>
                                <a href='https://large-type.com/#01711941680' target="_blank">
                                    <p class="designation"> Mobile: 01711941680</p>
                                </a>
                                <a href='https://msa@iiuc.ac.bd' target="_blank">
                                    <p class="designation"> E-mail: msa@iiuc.ac.bd</p>
                                </a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-sm-6 col-lg-3">
                        <div class="single_advisor_profile wow fadeInUp" data-wow-delay="0.5s" style={{ visibility: "visible", animationDelay: "0.5s", animationName: "fadeInUp", }}>
                            ...
                            <div class="advisor_thumb"><img src="https://cdn.pixabay.com/photo/2018/08/28/12/41/avatar-3637425_1280.png" alt="" />
                    ...
                    <div class="col-12 col-sm-6 col-lg-3">
                        <div class="single_advisor_profile wow fadeInUp" data-wow-delay="0.5s" style={{ visibility: "visible", animationDelay: "0.5s", animationName: "fadeInUp", }}>
                            ...
                            <div class="advisor_thumb"><img src="https://cdn.pixabay.com/photo/2023/01/12/08/36/man-7713621_640.jpg" alt="" />
                    ...
                    <div class="col-12 col-sm-6 col-lg-3">
                        <div class="single_advisor_profile wow fadeInUp" data-wow-delay="0.5s" style={{ visibility: "visible", animationDelay: "0.5s", animationName: "fadeInUp", }}>
                            ...
                            <div class="advisor_thumb"><img src="https://cdn.pixabay.com/photo/2023/01/12/08/25/man-7713605_640.jpg" alt="" />
                    ...
                    <div class="col-12 col-sm-6 col-lg-3">
                        <div class="single_advisor_profile wow fadeInUp" data-wow-delay="0.5s" style={{ visibility: "visible", animationDelay: "0.5s", animationName: "fadeInUp", }}>
                            ...
                            <div class="advisor_thumb"><img src="https://cdn.pixabay.com/photo/2013/07/12/14/36/man-148582_1280.png" alt="" />
